package com.example.bubbles.myrestaurants.services;

import android.util.Log;

import com.example.bubbles.myrestaurants.Constants;
        ...
        try {
            ...
            if (response.isSuccessful()) {
                ...
                for (int i = 0; i < businessesJSON.length(); i++) {
                    ...
                    if(name != null&& phone != null&&website != null&&imageUrl != null) {
                        restaurants.add(restaurant);
                    }
                    Log.e("No image found","YelpService");
                }
            }
